...
public class InventoryServiceTest {
    ...
    public void initInventoryOfStoreTest() {
        List<Inventory> inventoryList = inventoryService.initInventoryOfStore(store, "20180125");
        assertEquals(14, inventoryList.size());
        System.out.println("=================");
        System.out.println(JsonUtils.toJson(inventoryList));
        inventoryList = inventoryService.initInventoryOfStore(store, "20180126");
        assertEquals(26, inventoryList.size());
        System.out.println("=================");
        System.out.println(JsonUtils.toJson(inventoryList));
        inventoryList = inventoryService.initInventoryOfStore(store);
        assertEquals(118, inventoryList.size());
        System.out.println("=================");
        System.out.println(JsonUtils.toJson(inventoryList));
    }
